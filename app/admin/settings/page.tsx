...
interface Settings {
  ...
  todays_special_override: "main" | "majita_monday" | null;
}
  ...
  async function save() {
    ...
    await supabase
      ...
      .update({
        ...
        todays_special_override: settings.todays_special_override,
      })
      .eq("id", settings.id);
    setSaving(false);
    setSaved(true);
    ...
    <div className="max-w-2xl">
      ...
      <div className="space-y-6">
        <section>
          ...
          <p className="font-body text-bone/40 text-xs mt-2">
            This is where new order notifications are sent. Changing it here
            takes effect on the next order — no other setup needed.
          </p>
        </section>
        ...
        <section>
          <h2 className="font-body font-bold text-bone mb-3">Today&apos;s Special</h2>
          <p className="font-body text-bone/50 text-sm mb-3">
            Controls the &quot;Today&apos;s Special&quot; section on the homepage.
            Left on Auto, it shows the Majita Monday menu every Monday and
            nothing on other days. Override it to force a specific menu
            regardless of the day — e.g. running Majita Monday on a public
            holiday, or switching it off on a Monday it isn&apos;t happening.
          </p>
          <select
            value={settings.todays_special_override ?? "auto"}
            onChange={(e) =>
              update(
                "todays_special_override",
          ...
          >
            ...
            <option value="main">Force: Main menu</option>
          </select>
        </section>
