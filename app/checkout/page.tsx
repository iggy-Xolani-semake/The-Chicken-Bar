    ...
    return (
      <main className="min-h-screen flex items-center justify-center px-6 py-16">
        <div className="max-w-md w-full text-center space-y-6">
          ...
          <h1 className="font-display text-bone text-4xl">Order Received</h1>
          <p className="font-utility text-char text-lg">{completedOrder.orderNumber}</p>
          <p className="font-body text-bone/70">
            Your order has been saved. To confirm it with the restaurant, send us the
            pre-filled message on WhatsApp — we&apos;ll confirm your order and any
          ...
          <p className="font-body text-bone/40 text-xs">
            This order is not yet confirmed by the restaurant — WhatsApp us to finalize
            it.
          </p>
        </div>
      </main>
