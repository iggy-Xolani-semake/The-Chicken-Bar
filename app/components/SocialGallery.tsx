...
export default function SocialGallery() {
  ...
  useEffect(() => {
    ...
    supabase
      ...
      // The scatter animation (ImageScatter.tsx) creates raw DOM <img>
      // elements imperatively, not through React/next/image, so none of
      // the automatic resizing/format optimization applied elsewhere on
      // the site reaches this path. Capping the count is the main lever
      // left to keep load time reasonable — still enough photos for the
      // scatter effect to feel full (SCATTER_MIN_IMAGES is 10), well
      // short of the 120 this used to request.
      .limit(40)
      .then(({ data }) => {
